...
.dlls,er4f .dlls: mss_srr.per4f

-include package/cfg/mss_srr_per4f.mak
-include package/cfg/mss_srr_per4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/mss_srr_per4f.dep
endif
mss_srr.per4f: package/cfg/mss_srr_per4f.xdl
	@


ifeq (,$(wildcard .libraries,er4f))
mss_srr.per4f package/cfg/mss_srr_per4f.c: .libraries,er4f
endif

package/cfg/mss_srr_per4f.c package/cfg/mss_srr_per4f.h package/cfg/mss_srr_per4f.xdl: override _PROG_NAME := mss_srr.xer4f
package/cfg/mss_srr_per4f.c: package/cfg/mss_srr_per4f.cfg
package/cfg/mss_srr_per4f.xdc.inc: package/cfg/mss_srr_per4f.xdl
package/cfg/mss_srr_per4f.xdl package/cfg/mss_srr_per4f.c: .interfaces

clean:: clean,er4f
	-$(RM) package/cfg/mss_srr_per4f.cfg
	-$(RM) package/cfg/mss_srr_per4f.dep
	-$(RM) package/cfg/mss_srr_per4f.c
	-$(RM) package/cfg/mss_srr_per4f.xdc.inc

clean,er4f::
	-$(RM) mss_srr.per4f
.executables,er4f .executables: mss_srr.xer4f

mss_srr.xer4f: |mss_srr.per4f

-include package/cfg/mss_srr.xer4f.mak
mss_srr.xer4f: package/cfg/mss_srr_per4f.oer4f 
	$(RM) $@
	@$(MSG) lnker4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.R4F.rootDir)/bin/armlnk -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7R4 --strict_compatibility=on  -o $@ package/cfg/mss_srr_per4f.oer4f   package/cfg/mss_srr_per4f.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.R4F.rootDir)/lib/libc.a
	
mss_srr.xer4f: export C_DIR=
mss_srr.xer4f: PATH:=$(ti.targets.arm.elf.R4F.rootDir)/bin/;$(PATH)
mss_srr.xer4f: Path:=$(ti.targets.arm.elf.R4F.rootDir)/bin/;$(PATH)

mss_srr.test test,er4f test: mss_srr.xer4f.test

mss_srr.xer4f.test:: mss_srr.xer4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 mss_srr.xer4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.mss_srr.xer4f, ) 
endif

clean,er4f::
	-$(RM) $(wildcard .tmp,mss_srr.xer4f,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
mss_srr_per4f.oer4f,copy : package/cfg/mss_srr_per4f.oer4f
mss_srr_per4f.ser4f,copy : package/cfg/mss_srr_per4f.ser4f
