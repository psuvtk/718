...
C:/ti/bios_6_53_02_00/packages/ti/targets/elf/ITarget.xs:
package.mak: C:/ti/bios_6_53_02_00/packages/ti/targets/elf/ITarget.xs
C:/ti/bios_6_53_02_00/packages/ti/targets/elf/C28_float.xs:
package.mak: C:/ti/bios_6_53_02_00/packages/ti/targets/elf/C28_float.xs
C:/ti/bios_6_53_02_00/packages/ti/targets/elf/package.xs:
package.mak: C:/ti/bios_6_53_02_00/packages/ti/targets/elf/package.xs
...
ti.targets.elf.packageBase ?= C:/ti/bios_6_53_02_00/packages/ti/targets/elf/
...
.dlls,e674 .dlls: dss_srr.pe674

-include package/cfg/dss_srr_pe674.mak
-include package/cfg/dss_srr_pe674.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/dss_srr_pe674.dep
endif
dss_srr.pe674: package/cfg/dss_srr_pe674.xdl
	@


ifeq (,$(wildcard .libraries,e674))
dss_srr.pe674 package/cfg/dss_srr_pe674.c: .libraries,e674
endif

package/cfg/dss_srr_pe674.c package/cfg/dss_srr_pe674.h package/cfg/dss_srr_pe674.xdl: override _PROG_NAME := dss_srr.xe674
package/cfg/dss_srr_pe674.c: package/cfg/dss_srr_pe674.cfg
package/cfg/dss_srr_pe674.xdc.inc: package/cfg/dss_srr_pe674.xdl
package/cfg/dss_srr_pe674.xdl package/cfg/dss_srr_pe674.c: .interfaces

clean:: clean,e674
	-$(RM) package/cfg/dss_srr_pe674.cfg
	-$(RM) package/cfg/dss_srr_pe674.dep
	-$(RM) package/cfg/dss_srr_pe674.c
	-$(RM) package/cfg/dss_srr_pe674.xdc.inc

clean,e674::
	-$(RM) dss_srr.pe674
.executables,e674 .executables: dss_srr.xe674

dss_srr.xe674: |dss_srr.pe674

-include package/cfg/dss_srr.xe674.mak
dss_srr.xe674: package/cfg/dss_srr_pe674.oe674 
	$(RM) $@
	@$(MSG) lnke674 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.elf.C674.rootDir)/bin/cl6x -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --abi=eabi -z  -o $@ package/cfg/dss_srr_pe674.oe674   package/cfg/dss_srr_pe674.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.elf.C674.rootDir)/lib/libc.a
	
dss_srr.xe674: export C_DIR=
dss_srr.xe674: PATH:=$(ti.targets.elf.C674.rootDir)/bin/;$(PATH)
dss_srr.xe674: Path:=$(ti.targets.elf.C674.rootDir)/bin/;$(PATH)

dss_srr.test test,e674 test: dss_srr.xe674.test

dss_srr.xe674.test:: dss_srr.xe674
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 dss_srr.xe674.test
else
	@$(MSG) running $<  ...
	$(call EXEC.dss_srr.xe674, ) 
endif

clean,e674::
	-$(RM) $(wildcard .tmp,dss_srr.xe674,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
dss_srr_pe674.oe674,copy : package/cfg/dss_srr_pe674.oe674
dss_srr_pe674.se674,copy : package/cfg/dss_srr_pe674.se674
