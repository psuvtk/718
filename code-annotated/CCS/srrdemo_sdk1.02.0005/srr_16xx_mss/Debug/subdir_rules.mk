...
build-124162127:
	@$(MAKE) --no-print-directory -Onone -f subdir_rules.mk build-124162127-inproc

build-124162127-inproc: ../mss_srr.cfg
	@echo 'Building file: "$<"'
...
configPkg/linker.cmd: build-124162127 ../mss_srr.cfg
configPkg/compiler.opt: build-124162127
configPkg/: build-124162127
